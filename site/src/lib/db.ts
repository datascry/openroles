...
import { type Manifest, ManifestSchema } from "@openroles/shared";

// Env-detection for the build-time data dir. CI sets OPENROLES_DATA_DIR
// to the workspace `data/`; the public/data fallback fires only on the
// local dev server.
