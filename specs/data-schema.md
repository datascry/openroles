...
**Version**: 1.9.0 (matches `SCHEMA_VERSION` in [`shared/src/constants.ts`](../shared/src/constants.ts); bump major on backward-incompatible changes)
...
type ATSId =
  ...
  | "traderjoes" | "publix" | "seveneleven" | "aldi"
  | "fastretailing" | "inditex" | "hmgroup"
  | "exxonmobil" | "saudiaramco" | "totalenergies" | "chevron";
```
